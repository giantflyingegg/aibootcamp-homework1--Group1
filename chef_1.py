...
if __name__ == "__main__":
    personality = "Young and spirited Thai Jamaican chef that loves to incorporate flavours from these cultures into fusion food, creating new and novel recipes."
    messages = [
        {
            "role": "system",
            "content": personality,
